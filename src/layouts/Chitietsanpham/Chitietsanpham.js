            ...
            <div className={cx('body')}>
                <div className={cx('hinhnho')}>
                    ...
                    <div className={cx('chitiet')}>
                        <img onClick={() => setImg(item.img)} src={item.img} />
                    </div>
                    <div className={cx('chitiet')}>
                        <img onClick={() => setImg(item.img1)} src={item.img1} />
                    </div>
                    <div className={cx('chitiet')}>
                        <img onClick={() => setImg(item.img2)} src={item.img2} />
                    </div>
                ...
                <div className={cx('giohang')}>
                    ...
                    {/* <div>
                        <GrFormNext onClick={Prew} style={{ transform: 'rotate(180deg)' }} />
                        <span>{soluong}</span>
                        <GrFormNext onClick={() => setSoluong(soluong + 1)} />
                    </div> */}
