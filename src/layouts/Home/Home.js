        ...
        <div>
            <div className={cx('body')}>
                <div className={cx('banner')} >
                    <Row>
                        <img className={cx('banner')} src='https://theme.hstatic.net/200000182297/1000887316/14/ms_banner_img2.jpg?v=286' />
                    </Row>
                </div>
                <div className={cx('image')}>
                    <Row sm={2} xs={2}>
                        <Col className={cx('banner1')} data-aos="fade-right"
                            ...
                            <img className={cx('img')} src='https://theme.hstatic.net/200000182297/1000887316/14/home_new_banner_1.jpg?v=286' />
                        ...
                        <Col data-aos="fade-left"
                            ...
                            data-aos-offset="0"
                            data-aos-duration="1000" >
                            <img className={cx('img')} src='https://theme.hstatic.net/200000182297/1000887316/14/home_new_banner_2.jpg?v=286' />
                            <div className={cx('titlebtn')}>
                                <div className={cx('title')}>
                                    BEST SELECTER
                                </div>
                ...
                <div className={cx('banner')} >
                    <Row>
                        ...
                        <img className={cx('banner')} src='https://theme.hstatic.net/200000182297/1000887316/14/hb_image1.jpg?v=286' />
                    </Row>
